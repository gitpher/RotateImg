...
//
//    double xPrimePrime = (y * cos(radian)) + (x * sin(radian));
//    double yPrimePrime = (y * sin(radian)) - (x * cos(radian));
//
//    cout << "(" << xPrime << ", " << yPrime << ")" << endl;
//    cout << "(" << (int)(xPrime) << ", " << (int)(yPrime) << ")" << endl;
//
//    cout << endl;
//    cout << "(" << xPrimePrime << ", " << yPrimePrime << ")" << endl;
//    cout << "(" << (int)(xPrimePrime) << ", " << (int)(yPrimePrime) << ")" << endl;
//}
